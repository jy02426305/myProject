...
<head>
    ...
    <link rel="stylesheet" href="static/plugin/layuiadmin/layui/css/layui.css" media="all">
    <link rel="stylesheet" href="static/plugin/layuiadmin/style/admin.css" media="all">
...
<script src="./static/plugin/layuiadmin/layui/layui.js"></script>
<script>
    layui.config({
